...
<div class="work-card" id="work-${work.id}">
    ...
    <p>Patient: ${work.patient_name || "-"}</p>

    <p>Cost: ${work.work_cost} EGP</p>

    <p>Percent: ${work.doctor_percent}%</p>

    <p>Profit: ${work.doctor_profit} EGP</p>

    <p>${new Date(work.created_at).toLocaleString()}</p>
